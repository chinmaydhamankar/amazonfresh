 ...
 */
angular.module("amazonfresh").controller("TripAnalyticsController",["$scope","TripAnalyticsService", function ($scope, Service) {
	var promise = Service.getTripsPerDriver();
	promise.then(function (data) {
		$scope.analyticsData = processData(data);
