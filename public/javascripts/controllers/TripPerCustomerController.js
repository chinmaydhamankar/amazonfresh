 ...
 */
angular.module("amazonfresh").controller("TripPerCustomerController",["$scope","TripAnalyticsService", function ($scope, Service) {
	var promise = Service.getTripsPerCustomer();
